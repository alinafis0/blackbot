...
/* Creditos a Otosaka (https://wa.me/212681951915) */
...
const directories = ['./Blacksession/', './jadibts/']
...
if (reason == 405) {
await fs.unlinkSync("./Blacksession/" + "creds.json")
...
setInterval(async () => {
  ...
  const bio = `BLACK_BOT[ ⏳ ] Uptime: ${uptime}`;
